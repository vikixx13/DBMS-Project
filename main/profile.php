...
<body id="body">
  ...
  <section id="topbar" class="d-none d-lg-block">
    <div class="container clearfix">
      <div class="contact-info float-left">
        <i class="fa fa-envelope-o"></i> <a href="mailto:contact@example.com">dbms@thapar.edu</a>
  ...
  <section id="intro">
    ...
    <div class="intro-content">
      <h2>Connecting India<br>Since 1969</h2>
      <div>
  ...
  <footer id="footer">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>VikiTravels</strong>. All Rights Reserved
      </div>
      <div class="credits">
        
        Designed by <a href="#">Viki Reesit and Cheta </a>
      </div>
    </div>
  </footer><!-- #footer -->
